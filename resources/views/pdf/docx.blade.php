{{-- DOCX-safe view: tidak ada <!DOCTYPE>, <html>, <head>, <body> --}}
{{-- Semua <br/> / <hr/>, <img ... /> self-closing, &nbsp; => &#160; --}}
...
<div style="font-family:'Times New Roman', Times, serif; font-size:11pt;">
  ...
  <table width="100%">
    <tr>
      <td width="0%" align="center">
        <img src="file://{{ public_path('img/kop.png') }}" width="92" alt="Logo" />
      </td>
      <td valign="top" width="100%" align="center">
        <b style="font-size:24px;">PEMERINTAH KABUPATEN PACITAN</b>
        <br/><b style="font-size:24px;">KECAMATAN SUDIMORO</b>
  ...
  <div style="text-align:center;">
    <b style="font-size:20px;"><u>Surat Perintah Tugas</u></b>
  </div>

  @foreach($data->take(1) as $sppd_one)
    <div style="text-align:center;">Nomor : {{ $sppd_one->no_surat }}</div>
  @endforeach
  ...
  <table border="0" width="100%">
    <tr>
      ...
      <td>1. </td>
      <td>Peraturan Daerah Kabupaten Pacitan Nomor 8 Tahun 2024 tentang Pendapatan dan Belanja Daerah Kabupaten Pacitan Tahun Anggaran 2025</td>
    </tr>
    <tr>
      <td width="60"></td>
      <td>2. </td>
    ...
    <tr>
      <td width="60"></td>
      <td>3. </td>
      <td>Peraturan Bupati Pacitan Nomor 21 Tahun 2024 tentang Standar Biaya Umum Pemerintah Kabupaten Pacitan Tahun Anggaran 2025</td>
    </tr>
    <tr>
      <td width="60"></td>
      <td>4. </td>
  ...
  <div style="text-align:center;"><b>MEMERINTAHKAN</b></div>
  ...
  <table width="100%" border="0">
    ...
    <tr>
      <td></td>
      <td>: 3.</td>
      <td>Bertempat di {{ $first?->tujuan }}</td>
    </tr>
  </table>
  ...
  <div class="page-break-a">
    <table border="0" width="100%">
      ...
      <tr>
        <td width="310" style="height:35px;"></td>
      </tr>
      <tr>
        <td width="310"></td>
  ...
  @foreach($data as $sppd)
    ...
    <div style="text-align:center;">
      <b style="font-size:20px;"><u>SURAT PERJALANAN DINAS (SPD)</u></b>
    </div>
    ...
    <table width="100%" border="1">
      ...
      <tr>
        <td width="4%"></td>
        <td width="35%">c. Tingkat Biaya Perjalanan Dinas</td>
        <td width="4%">:</td>
      ...
      <tr>
        <td width="4%">7</td>
        <td width="35%">a. Lamanya Perjalanan Dinas</td>
        <td width="4%">:</td>
      ...
      @php($currentPage = $loop->iteration)
  ...
  @foreach($data->take(1) as $kuitansi)
    <div style="text-align:center;"><b style="font-size:20px;">RINCIAN BIAYA PERJALANAN DINAS DALAM DAERAH</b></div>
    <br/><br/>
    <div style="text-align:center;"><b style="font-size:24px;">KUITANSI</b></div>
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <td style="border-bottom: 1px solid black; vertical-align: middle;">:
          @if($first?->jenis_sppd?->id == 1)
            Uang Transport
          @else
            Uang Harian
          @endif
          {{ $kuitansi->perihal }} di {{ $kuitansi->tujuan }} pada Tgl {{ $tgl_berangkat }}
        </td>
      </tr>
      <tr>
  ...
  <table border="1" width="100%">
    <tr>
      ...
      <td align="center" width="30%"><b>PERHITUNGAN BIAYA</b></td>
      <td align="center" width="25%"><b>JUMLAH</b></td>
      <td align="center" width="41%"><b>NAMA DAN TANDA TANGAN PENERIMA</b></td>
    </tr>
    <tr>
  ...
  <div style="text-align:center;"><b style="font-size:24px;">LAPORAN PERJALANAN DINAS</b></div>
  <p></p>
  ...
  <table width="100%">
    ...
    <tr>
      ...
      <td width="68%" style="text-align: justify; height:70px;">: ................................................................................................................................
        <br/>..................................................................................................................................
        <br/>..................................................................................................................................
        <br/>..................................................................................................................................
        <br/>..................................................................................................................................
    ...
    <table width="100%" border="1">
      <tr>
        ...
        <td width="48%">
          ...
          <br/>Ke &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; &#160; : {{ $first?->tujuan }}
          <br/><br/>
          <div style="text-align:center;"><b>CAMAT SUDIMORO</b></div>
          <br/><br/><br/>
          <div style="text-align:center;"><b><u>{{ $camat->nama }}</u></b></div>
          <div style="text-align:center;">NIP. {{ $camat->nip }}</div>
        </td>
      </tr>
      <tr>
        <td style="border-right: none;" width="2%">II</td>
        <td style="border-left: none; height:80px;" width="48%">
          Tiba di &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; : {{ $first?->tujuan }}
          <br/>Pada Tanggal&#160; : {{ $tgl_berangkat }}
          <br/>Kepala&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; :
          <br/><br/><br/><br/><br/><br/>
        </td>
        <td width="48%">
          Berangkat dari &#160; : {{ $first?->tujuan }}
      ...
      <tr>
        ...
        <td width="48%" style="text-align: justify;">
          ...
          <br/><br/>
          <div style="text-align:center;"><b>PENGGUNA ANGGARAN</b></div>
          <br/><br/><br/>
          <div style="text-align:center;"><b><u>{{ $camat->nama }}</u></b></div>
          <div style="text-align:center;">NIP. {{ $camat->nip }}</div>
        </td>
